...
set xo_kernel_name "EthInTop"
set xo_kernel_files {}
set enable_xo_gen true
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/root/okx/build/_x/EthInTop/EthInTop/EthInTop/solution"
set debug_dir "/root/okx/build/_x/EthInTop/EthInTop/EthInTop/solution/.debug"
set xo_hls_files_dir ""
set hdl_module_list {EthInTop_control_s_axi
EthInTop_gmem_m_axi
regslice_core
EthInTop
}
...
set Interfaces {
    ...
    ap_clk {
        ...
        buses "s_axi_control m_axi_gmem ethernet_stream_out"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    ethernet_stream_out {
        type "axi4stream"
        mode "master"
        port_prefix "ethernet_stream_out"
        has_tready "1"
        ports {
            TDATA 64
            TLAST 1
