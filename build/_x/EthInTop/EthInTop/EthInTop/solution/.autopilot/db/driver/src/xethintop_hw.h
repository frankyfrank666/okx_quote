...
#define XETHINTOP_CONTROL_ADDR_GIE           0x04
#define XETHINTOP_CONTROL_ADDR_IER           0x08
#define XETHINTOP_CONTROL_ADDR_ISR           0x0c
#define XETHINTOP_CONTROL_ADDR_IN_R_DATA     0x10
