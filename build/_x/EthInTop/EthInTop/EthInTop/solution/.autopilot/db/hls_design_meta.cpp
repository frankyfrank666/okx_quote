...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("ethernet_stream_out_TDATA", 64, hls_out, 3, "axis", "out_data", 1),
	Port_Property("ethernet_stream_out_TVALID", 1, hls_out, 6, "axis", "out_vld", 1),
	Port_Property("ethernet_stream_out_TREADY", 1, hls_in, 6, "axis", "out_acc", 1),
	Port_Property("ethernet_stream_out_TKEEP", 8, hls_out, 4, "axis", "out_data", 1),
	Port_Property("ethernet_stream_out_TSTRB", 8, hls_out, 5, "axis", "out_data", 1),
	Port_Property("ethernet_stream_out_TLAST", 1, hls_out, 6, "axis", "out_data", 1),
