...
#include <iostream>
#include <pcap.h>
#include "/root/okx/src/include/utils.h"
#include "../TcpTop.h"
...
int main() {
    hls::stream<ethernetAxi64> eth_input_stream("eth_in_stream");
    replayPcap("/root/okx/src/Tcp/Test/pcaps/packet_6.pcap", eth_input_stream);

    ap_uint<32> mDelayCycles = 10000;
    ...
    while(!eth_input_stream.empty())
        TcpTop(mDelayCycles, mMyIp, mMyMac, mMyPort, mTargetIp, mTargetMac, mTargetPort, mCommand, mAskPriceInt, mAskPriceDec, mAskVol, eth_input_stream);
