...
// {
//     static EthernetAxi64 packetIn;
//     if(payloadStreamIn.read_nb(packetIn))
//     {
//         for (int i = 63; i > 0; i = i-8 )
//         {
//     #pragma hls unroll 
//             PayloadParserHelper(askPxInt, askPxDec, askSz, packetIn.last, packetIn.data(i, i - 7)); //Try make this single cycle.
//         }
//     }
// }
