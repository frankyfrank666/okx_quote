...
int PayloadParserHelper(ap_uint<32>& askPxInt, ap_uint<32>& askPxDec, ap_uint<32>& askSz, ap_uint<1> last, ap_uint<8> character) //too many adders, no way to meet timing
{
#pragma hls inline
